#!/bin/bash
yad --title "BOKI-HELLO-2" --form --center --borders=15 --columns=3 --width=540 --height=190 --window-icon=icons/logo.png --text="W E L C O M E  T O  B O K I - H E L L O - 2 !!!" --text-align=center --image=icons/logo.png \
